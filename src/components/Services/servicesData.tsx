...
const servicesData: Service[] = [
  {
    ...
    title: "Web Design",
    description:
      "Create stunning, modern websites with responsive design that engage users and drive conversions. Our designs balance aesthetics with functionality.",
    features: [
      "UI/UX Design",
      "Responsive layouts",
  ...
  },
  {
    ...
    description:
      "Build powerful, scalable web applications using cutting-edge technologies and best practices for performance and maintainability.",
    features: [
  ...
  },
  {
    ...
    description:
      "Develop multi-tenant Software-as-a-Service applications with subscription management, analytics, and scalable infrastructure.",
    features: [
  ...
  },
  {
    ...
    description:
      "Create custom applications tailored to your business needs with modern architecture and seamless integration with existing systems.",
    features: [
  ...
  },
  {
    ...
    description:
      "Design intuitive and engaging user experiences through research, testing, and iterative design to maximize user satisfaction and engagement.",
    features: [
  ...
  },
  {
    ...
    description:
      "Build cloud-native applications leveraging AWS, Azure, and Google Cloud with microservices, containerization, and DevOps practices.",
    features: [
  ...
  },
  {
    ...
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" className="fill-current">
        <path
          opacity="0.5"
          d="M20 0C31.0457 0 40 8.95431 40 20C40 31.0457 31.0457 40 20 40C8.95431 40 0 31.0457 0 20C0 8.95431 8.95431 0 20 0ZM20 4C11.1634 4 4 11.1634 4 20C4 28.8366 11.1634 36 20 36C28.8366 36 36 28.8366 36 20C36 11.1634 28.8366 4 20 4Z"
        />
        <path d="M20 8C14.4772 8 10 12.4772 10 18C10 23.5228 14.4772 28 20 28C25.5228 28 30 23.5228 30 18C30 12.4772 25.5228 8 20 8ZM20 12C23.3137 12 26 14.6863 26 18C26 21.3137 23.3137 24 20 24C16.6863 24 14 21.3137 14 18C14 14.6863 16.6863 12 20 12Z" />
      </svg>
    ),
    title: "Mobile Application Development",
    description:
      "Develop native iOS and Android apps or cross-platform mobile solutions with exceptional performance and user engagement.",
    features: [
  ...
  },
  {
    ...
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" className="fill-current">
        <path
          opacity="0.5"
          d="M30 20C30 26.6274 25.5228 32 20 32C14.4772 32 10 26.6274 10 20C10 13.3726 14.4772 8 20 8C25.5228 8 30 13.3726 30 20Z"
        />
    ...
    description:
      "Extend your development capacity with dedicated remote teams for projects. Scale your workforce without overhead costs.",
    features: [
