  ...
  return (
    <div className="shadow-three dark:bg-gray-dark relative z-10 rounded-xs bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
      ...
      <p className="border-body-color/25 text-body-color mb-11 border-b pb-11 text-base leading-relaxed dark:border-white/25">
        Get the latest insights on software development trends, technology updates, and industry best practices delivered directly to your inbox.
      </p>
      <div>
        <input
          type="text"
        ...
        <p className="text-body-color dark:text-body-color-dark text-center text-base leading-relaxed">
          Join thousands of developers and businesses staying ahead of the curve with our expert insights.
        </p>
      </div>
