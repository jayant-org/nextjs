              ...
              <div>
                ...
                <div>
                  ...
                  <p className="text-body-color mb-8 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Modern software development requires a balance between speed and quality. Our team employs industry-leading practices to ensure your applications are
                    <strong className="text-primary dark:text-white">
                      {" "}
                      robust, scalable, and maintainable{" "}
                    </strong>
                    . We focus on code quality, comprehensive testing, and continuous improvement. Every line of code is carefully crafted to meet your business objectives and provide exceptional user experiences that drive engagement and loyalty.
                  </p>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    ...
                    . Throughout every project phase, we keep you informed with regular updates and invite your feedback. Our agile approach ensures flexibility to adapt to changing requirements while maintaining project momentum and delivering on schedule.
                  </p>
                  ...
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Whether you're building a new platform from scratch or modernizing legacy systems, we have the expertise and experience to deliver results. Our portfolio spans startups to enterprise solutions, and we pride ourselves on building long-term partnerships with our clients.
                  </p>
                  ...
                  <div className="bg-primary/10 relative z-10 mb-10 overflow-hidden rounded-md p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-body-color text-center text-base font-medium italic">
                      "Success is not just about delivering software—it's about building solutions that create real value for your business and your users."
                    </p>
