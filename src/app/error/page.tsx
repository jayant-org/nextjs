...
export const metadata: Metadata = {
  title: "Page Not Found | Software Development Company",
  description: "The page you're looking for doesn't exist. Explore our software development services including web applications, mobile apps, and digital transformation solutions.",
  // other metadata
};
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                ...
                <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                  The page you're looking for seems to have wandered off into the digital void. Don't worry though - let's get you back to exploring our software development services and innovative solutions.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Link
                    href="/services"
                    className="px-8 py-3 text-base font-bold text-primary duration-300 rounded-md border-2 border-primary bg-transparent hover:bg-primary hover:text-white md:px-9 lg:px-8 xl:px-9"
                  >
                    Our Services
                  </Link>
                  <Link
                ...
                <div className="mt-8 text-center">
                  ...
                  <div className="flex flex-wrap justify-center gap-4 text-sm">
                    ...
                    <span className="text-body-color dark:text-body-color-dark">•</span>
